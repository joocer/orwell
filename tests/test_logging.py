"""
Test the orwell logger, this extends the Python logging logger.
We test that the trace method and decorators raise no errors.
"""
import os
import sys
sys.path.insert(1, os.path.join(sys.path[0], '..'))
from orwell.logging import LEVELS, get_logger, set_log_name
try:
...
def test_adding_logging_levels_fails_if_the_level_already_exists():
    ...
    from orwell.logging import add_level
